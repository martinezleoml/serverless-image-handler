#!/bin/bash
#
# This script should be run from the repo's scripts directory
# cd scripts
# ./run-unit-tests.sh
#
...
image_handler_dir="$template_dir/../src/image-handler"
coverage_reports_top_path="$template_dir/../src/test/coverage-reports"
